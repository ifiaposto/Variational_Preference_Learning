...
from vrm.models import Qwen2ForSequenceClassification
from vrm.trainer import RewardTrainer
...
if __name__ == "__main__":
    parser = HfArgumentParser(
        (RewardScriptArguments, RewardConfig, ModelConfig))
